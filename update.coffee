...
getTags = (callback) ->
  requestOptions =
    url: 'https://raw.githubusercontent.com/chrisgriffith/Zurb-Brackets-Extension/master/HtmlTags.json'
    json: true
...
getAttributes = (callback) ->
  requestOptions =
    url: 'https://raw.githubusercontent.com/chrisgriffith/Zurb-Brackets-Extension/master/HtmlAttributes.json'
    json: true
